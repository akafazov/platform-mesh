...
var components = map[string]component{
	...
	"platform-mesh-operator":      {"platform-mesh-operator/v", "platform-mesh-operator.yml: builds + signs the image, cuts a GitHub release, bumps the chart, publishes SBOM + signed OCM component"},
	...
	"kro-composition-operator":    {"kro-composition-operator/v", "kro-composition-operator.yml: builds + signs the image, cuts a GitHub release, bumps the chart, publishes SBOM + signed OCM component"},
